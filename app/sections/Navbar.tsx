...
const Navbar = (props: Props) => {
  ...
  return (
    <>
      <nav
        ref={navRef}
        className='fixed z-50 flex-col justify-between w-full h-full px-10 uppercase bg-black text-white/80 py-28 gap-y-10 md:w-1/2 md:left-1/2'
      >
        ...
        >
          ...
          <div className='font-light'>
            <p className='tracking tracking-wider text-white/50'>
              {' '}
              Social media
            </p>
