...
function AnimatedHeaderSection({subtitle,title,text,textColor,withScrollTrigger}:{
    subtitle?:string,
    title?:string,
    text?:string,
    textColor?:string,
    ...
    <div ref ={contextRef}>
          ...
          <div className={`relative px-10 ${textColor}`}>
            ...
            <div className='py-12 sm:py-16 text-end' >
                <AnimatedTextLine text={text ?? ''} className={`font-light uppercase value-text-responsive ${textColor}`}/>
